...
class OneDrive
{
	...
	public function ping()
	{
		...
		// Try to get the drive information. It's our test to see if the token works.
		try
		{
	...
	public function createUploadSession($path)
	{
		...
		// For some reason this is ignored by OneDrive?! You have to try deleting the file before uploading it.
