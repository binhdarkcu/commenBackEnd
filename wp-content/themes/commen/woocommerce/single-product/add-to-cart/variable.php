			...
			<tbody>
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<?php 
                	  ...
                	  if($options && count($options) == 1 && $selected){ ?>
						<tr>
							<td class="label"><label for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo wc_attribute_label( $attribute_name ); ?>: <?php echo $product->get_variation_default_attribute( $attribute_name); ?></label>
						</td>
